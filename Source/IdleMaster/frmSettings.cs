...
namespace IdleMaster
{
    public partial class frmSettings : Form
    {
        ...
        private void btnOK_Click(object sender, EventArgs e)
        {
            ...
            if (numSimultaneousIdleTime.Value < 60)
                numSimultaneousIdleTime.Value = 60;
            Settings.Default.SimultaneousIdleTime = (int)numSimultaneousIdleTime.Value;
        ...
        private void frmSettings_Load(object sender, EventArgs e)
        {
            ...
            string manyThenOne = string.Format(localization.strings.idle_simultaneous, Settings.Default.SimultaneousIdleTime / 60.0);
            radManyThenOne.Text = manyThenOne;
            ttHints.SetToolTip(radManyThenOne, manyThenOne);
            string oneThenMany = string.Format(localization.strings.idle_onethenmany, Settings.Default.SimultaneousIdleTime / 60.0);
            radOneThenMany.Text = oneThenMany;
            ttHints.SetToolTip(radOneThenMany, oneThenMany);
            ...
            lblSimultaneousTime.Text = localization.strings.simultaneous_idle_time;
            ...
            numSimultaneousIdleTime.Value = Settings.Default.SimultaneousIdleTime;
        }
        ...
        private void numSimultaneousIdleTime_ValueChanged(object sender, EventArgs e)
        {
            string manyThenOne = string.Format(localization.strings.idle_simultaneous, (int)numSimultaneousIdleTime.Value / 60.0);
            radManyThenOne.Text = manyThenOne;
            ttHints.SetToolTip(radManyThenOne, manyThenOne);
            string oneThenMany = string.Format(localization.strings.idle_onethenmany, (int)numSimultaneousIdleTime.Value / 60.0);
            radOneThenMany.Text = oneThenMany;
            ttHints.SetToolTip(radOneThenMany, oneThenMany);
        }

        private void numSimultaneousIdleTime_KeyUp(object sender, KeyEventArgs e)
        {
            string manyThenOne = string.Format(localization.strings.idle_simultaneous, (int)numSimultaneousIdleTime.Value / 60.0);
            radManyThenOne.Text = manyThenOne;
            ttHints.SetToolTip(radManyThenOne, manyThenOne);
        ...
        private void numSimultaneousIdleTime_Leave(object sender, EventArgs e)
        {
            if (numSimultaneousIdleTime.Value < 60)
                numSimultaneousIdleTime.Value = 60;
        }
